...
AS
BEGIN
	DECLARE @ID_BENHNHAN INT = (SELECT TOP 1 KHDT.ID_BENHNHAN FROM KEHOACH_DIEUTRI KHDT 
								JOIN THONGTIN_THANHTOAN TT ON TT.ID_KEHOACH_DIEUTRI = KHDT.ID_KEHOACH_DIEUTRI);
...
EXEC THANHTOAN_KEHOACH_DIEUTRI 100001, 160, 0, 160, N'ONLINE', ''
GO
...
BEGIN
	...
	SET
		...
		NGAYTHANHTOAN = GETDATE()
	WHERE
		ID_THONGTIN_THANHTOAN_DONTHUOC = @ID_THONGTIN_THANHTOAN; 
	
	DECLARE @ID_BENHNHAN INT = (SELECT TOP 1 DT.ID_BENHNHAN FROM THONGTIN_THANHTOAN_DONTHUOC TT
								JOIN DONTHUOC DT ON DT.ID_DONTHUOC = TT.ID_DONTHUOC)
...
GO 
-- TEST
select * from THONGTIN_THANHTOAN_DONTHUOC
EXEC THANHTOAN_DONTHUOC 9, 68, 68, 68, 'Online', ''
...
CREATE OR ALTER PROCEDURE XEM_TONGTIENTHANHTOAN_THONGTIN_THANHTOAN
	@ID_THONGTIN_THANHTOAN INT
AS
BEGIN
	SELECT ID_THONGTIN_THANHTOAN, TONGTIENTHANHTOAN
