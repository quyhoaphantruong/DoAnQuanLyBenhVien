...
BEGIN
	...
	INSERT INTO CUOCHEN(ID_BENHNHAN, ID_NHASI, ID_TROKHAM, ID_PHONGKHAM, THOIGIAN, GHICHU, TINHTRANG)
	VALUES (@ID_BENHNHAN, @ID_NHASI, @ID_TROKHAM, @ID_PHONGKHAM, @THOI_GIAN, @GHICHU, @TINHTRANG)
...
SELECT * FROM CUOCHEN
EXEC TAO_CUOCHEN 2, 'NV_2', '', 'PK1', '2023-01-28 8:30', '' 
GO
--Xóa cuộc hẹn
